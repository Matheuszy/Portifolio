      ...
      <section id="about" className="section about">
        ...
        <div className="about-grid">
          ...
          <div className="about-copy">
            <p>
              Trago uma perspectiva analítica e orientada a dados para o desenvolvimento de software. Minha experiência prévia me ensinou a transformar problemas complexos em requisitos claros e decisões arquiteturais robustas. Hoje, atuo como Engenheiro de Software projetando sistemas eficientes, garantindo código limpo, boa manutenibilidade e alinhamento direto com as necessidades estratégicas do negócio.
            </p>
            <p>
